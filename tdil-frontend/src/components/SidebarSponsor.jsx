      ...
      <div className="flex flex-col flex-1 min-h-0 bg-white border-r border-gray-200">
        ...
        <div className="flex items-center justify-between h-16 px-4 bg-purple-600 text-white">
          <div className="flex items-center">
            <div className="w-8 h-8 bg-purple-800 rounded-lg flex items-center justify-center text-white font-bold text-xs">
              tDIL
            </div>
            <span className="ml-2 text-lg font-semibold">Sponsor Portal</span>
          </div>
        </div>
