...
export default function ChatPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <SidebarMember />
        <div className={`${isCollapsed ? 'md:ml-16' : 'md:ml-64'} flex items-center justify-center`}>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`${isCollapsed ? 'md:ml-16' : 'md:ml-64'} flex h-screen transition-all duration-300`}>
        {/* Main Chat Area */}
