...
import { getOrgSlug } from '../utils/slugify';
      ...
      <div className={`bg-white rounded-xl border overflow-hidden transition-shadow hover:shadow-md ${isFeatured ? 'border-yellow-300 shadow-sm' : 'border-gray-200'}`}>
        ...
        <div className="p-5">
          ...
          <div className="flex items-start gap-4 mb-4">
            <Link to={`/org/${getOrgSlug(school)}`} className="w-16 h-16 rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden bg-purple-100 hover:opacity-80 transition-opacity">
              {school.profileImage
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-2">
                <div>
                  <Link to={`/org/${getOrgSlug(school)}`} className="font-bold text-gray-900 text-base leading-tight hover:text-purple-700 transition-colors block">
